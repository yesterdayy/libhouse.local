...
@section('body')
    ...
    <div class="app row m-n" id="app" data-controller="@yield('controller')" @yield('controller-data')>
        ...
        <div class="aside col-xs-12 col-md-3 col-xl-2 col-xxl-2 offset-admin-1 offset-xxl-2 no-padder bg-dark">
        ...
        <div class="col-md-9 col-xl-9 col-xxl-6 bg-white b-r box-shadow-lg no-padder">
    ...
    <div id="picture-preview" class="modal fade" role="dialog">
