...
return [
    ...
    */
    ...
    'email_rfc'                 => 'Некорректный :attribute',
    'phone'                 => 'Некорректный :attribute',
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'доступно',
        'size'                  => 'оазмер',
        'user_realty_type' => 'тип аккаунта',
        'trade_type' => 'тип сделки',
        'duration' => 'тип аренды',
        'dop_type' => 'категория недвижимости',
        'rent_type' => 'тип недвижимости',
        'type' => 'объект',
        'address_city' => 'город',
        'address_street' => 'улица',
        'room_type' => 'количество комнат',
        'info.floor' => 'этаж',
        'info.floors' => 'этажей в доме',
        'info[square_common]' => 'общая площадь',
        'info[square_living]' => 'жилая площадь',
        'info[square_kitchen]' => 'площадь кухни',
        'youtube' => 'видео',
        'content' => 'описание объявления',
        'price' => 'стоимость',
        'info[with_communal]' => 'коммунальные услуги включены',
    ],
];
